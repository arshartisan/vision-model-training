...
while True:
    ...
    # Count impure (0), pure (1), unwanted (2) - based on classes.txt order
    impure_count = class_ids.count(0)
    pure_count = class_ids.count(1)
    unwanted_count = class_ids.count(2)
    ...
    cv2.rectangle(annotated_frame, (5, 5), (520, 140), (0, 0, 0), -1)
    ...
    cv2.putText(annotated_frame, f"Pure: {pure_count} | Impure: {impure_count} | Unwanted: {unwanted_count}", (10, 60),
